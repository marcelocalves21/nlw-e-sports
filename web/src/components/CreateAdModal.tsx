...
export function CreateAdModal() {
  ...
  async function handleCreateAd(event: FormEvent) {
    ...
    try{
      ...
      alert("Ad was successfully created")
    } catch(err) {
      console.log(err)
      alert('Error, ad not created')
    }
      ...
      <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/50">
        ...
        <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input type="text" name="name" id="name" placeholder="Your name in the game" />
          </div>

          <div className="grid grid-cols-2 gap-6">
            <div className="flex flex-col gap-2">
              <label htmlFor="yearsPlaying">How long do you play?</label>
              <Input type="number" name="yearsPlaying" id="yearsPlaying" placeholder="0 is ok" />
            </div>
            <div className="flex flex-col gap-2">
              <label htmlFor="discord">What is your discord?</label>
              <Input type="text" name="discord" id="discord" placeholder="Username#0000" />
            </div>
          </div>
